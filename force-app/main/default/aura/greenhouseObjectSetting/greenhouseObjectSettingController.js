({
    ...
    getSelectedMainObjectName: function(component, event, helper) {
        ...
        helper.clearMappingHelperSalesforceReference(component, event, helper,fieldItem);
    ...
    saveRecords: function(component, event, helper) {
        ...
        for(var i =0; i < greenWrapList.length; i++){
            ...
            if(greenWrapList[i].salesforceField != '' && greenWrapList[i].salesforceField != null){
                console.log('cgfavdhjsa'+component.get("v.lookupFields"));
                helper.toggleToastHelper(component, event, helper,'error','Look up blank');
                return null;
            }
    ...
    getActiveSection : function(component,event,helper){
        ...
        if(component.find("accordion").get('v.activeSectionName') != undefined){
            ...
            var action = component.get("c.getSelectedReferenceField");
            action.setParams({
                objName : component.find("accordion").get('v.activeSectionName')
            })
            ...
            action.setCallback(this, function(response){          
                if(response.getState() == 'SUCCESS'){
                    if(response.getReturnValue() != null){
                        component.set("v.lookupFields",response.getReturnValue());
                    }else{
