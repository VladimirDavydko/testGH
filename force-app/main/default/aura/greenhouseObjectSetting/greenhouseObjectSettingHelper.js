({
    ...
    clearMappingHelperSalesforceReference : function(component, event, helper,salesforceObj) {
        console.log('salesforceObj===='+salesforceObj);
        //component.set("v.lookupFields",'');
        var greenHouseTable;
        var selectedObject = component.get("c.clearMappingListReference");
